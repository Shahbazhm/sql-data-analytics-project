...
--Adding some basic transformations to prepare for aggregations
...
/*
----------------------------------------------------------------
3) Final Results: Combines all customer results into one output
----------------------------------------------------------------
...
SELECT 
  ...
  customer_name, 
  age, 
  CASE WHEN age < 20 THEN 'Under 20' WHEN age BETWEEN 20 
  AND 29 THEN '20-29' WHEN age BETWEEN 30 
  AND 39 THEN '30-39' WHEN age BETWEEN 40 
  AND 49 THEN '40-49' ELSE '50 and above' END AS age_group, 
  CASE WHEN lifespan >= 12 
  and total_sales > 5000 THEN 'VIP' WHEN lifespan >= 12 
